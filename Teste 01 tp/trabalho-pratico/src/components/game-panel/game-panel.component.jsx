...
function GamePanel (props) {
    ...
    return (
		<div>
			...
			{isShownSuper && (<table id="table"><tr>
					<td id="letra"></td>
					<td id="letra"></td>
					<td id="letra">D</td>
					<td id="letra"></td>
			...
			{isShownSuper && (<div id="box_palavras">
				<a>REACT</a>
				<a>DADOS</a>
				<a>JS</a>
				<a>CURSO</a>
